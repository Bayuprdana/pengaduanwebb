...
if ($_SESSION['level']!="petugas"){
    echo "<script>alert('Maaf Anda Bukan seorang petugas'); window.location.assign('../index2.php'); </script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
>>>>>>> 264245907be445b12b2461115e0a5e83d6cc46fd
